"""
URL configuration for warrantywallet project.
...
from receipts.views import CustomerHomeView
...
urlpatterns = [
    ...
    path('api/customer/home/', CustomerHomeView.as_view(), name='customer-home'),
]
